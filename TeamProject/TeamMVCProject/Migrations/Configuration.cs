namespace TeamMVCProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TeamMVCProject.Context.TeamsPlayersContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "TeamMVCProject.Context.TeamsPlayersContext";
        }

        protected override void Seed(TeamMVCProject.Context.TeamsPlayersContext context)
        {
